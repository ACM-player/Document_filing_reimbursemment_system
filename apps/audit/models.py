...
class AuditAction(models.TextChoices):
    ...
    FILE_DOWNLOADED = "FILE_DOWNLOADED", "文件下载"
    FILE_QUARANTINED = "FILE_QUARANTINED", "文件隔离"
    FILE_MARKED_MISSING = "FILE_MARKED_MISSING", "文件标记缺失"
    FILE_INTEGRITY_FAILED = "FILE_INTEGRITY_FAILED", "文件完整性校验失败"
    FILE_RECONCILED = "FILE_RECONCILED", "文件状态核对修复"
    FILE_ORPHAN_DETECTED = "FILE_ORPHAN_DETECTED", "检测到孤立文件"
    FILE_STAGING_CLEANED = "FILE_STAGING_CLEANED", "清理过期暂存文件"
    DOCUMENT_SOFT_DELETED = "DOCUMENT_SOFT_DELETED", "文档软删除"
    DOCUMENT_RESTORED = "DOCUMENT_RESTORED", "文档恢复"
